...
class FiLMoSNet(nn.Module):
    def __init__(
        ...
        # ``adaptive`` is the proposed model.  The remaining modes are used by
        # the controlled ablation runner while keeping the encoder/refinement
        # implementation and training pipeline unchanged.
        self.fusion_mode = "adaptive"
    ...
    def forward(self, x: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        elif self.fusion_mode == "orientation":
        ...
        elif self.fusion_mode == "morphology":
