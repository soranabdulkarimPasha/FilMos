...
This is an actual seed-42 run on the untouched fixed BUSI test set. Checkpoint epoch 18 was selected only by validation macro-F1.
...
|---|---:|
| Accuracy | 0.8983 |
| Cohen's kappa | 0.8217 |
| Macro-F1 | 0.9020 |
| Macro sensitivity | 0.8911 |
| Macro specificity | 0.9307 |
| Macro AUROC (OvR) | 0.9552 |
| Macro AUPRC | 0.9324 |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| benign | 66 | 0.8750 | 0.9545 | 0.8269 | 0.9130 | 0.9391 | 0.9474 |
| malignant | 32 | 0.8846 | 0.7188 | 0.9651 | 0.7931 | 0.9266 | 0.8498 |
...
- Training wall time (seconds): 683.4
- Test prediction file: `dsdnet_test_predictions.csv`
- Machine-readable report: `dsdnet_test_report.json`
