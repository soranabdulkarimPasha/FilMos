...
This is an actual seed-44 run on the untouched fixed BUSI test set. Checkpoint epoch 17 was selected only by validation macro-F1.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| benign | 66 | 0.8788 | 0.8788 | 0.8462 | 0.8788 | 0.9312 | 0.9411 |
| malignant | 32 | 0.7500 | 0.7500 | 0.9070 | 0.7500 | 0.9128 | 0.8191 |
...
- Training wall time (seconds): 694.7
- Test prediction file: `dsdnet_seed44_test_predictions.csv`
- Machine-readable report: `dsdnet_seed44_test_report.json`
